        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <img
              ...
              alt=""
            />
            {/* <img width="137" height="64" src="https://www.ubagroup.com/wp-content/uploads/2022/03/logo.svg" class="attachment-full size-full wp-image-437140" alt="uba website brand logo">			 */}
          </div>
          {!collapsed && (
            <div>
